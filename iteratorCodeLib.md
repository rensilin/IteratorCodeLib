...
- [1. 实用数据结构](#1-实用数据结构)
    ...
    - [1.2. 树状数组](#12-树状数组)
        ...
        - [1.2.2. 重复覆盖](#122-重复覆盖)
    - [1.3. splay](#13-splay)
        - [1.3.1. 头文件&宏&全局变量&结构体](#131-头文件宏全局变量结构体)
        - [1.3.2. 辅助函数](#132-辅助函数)
        - [1.3.3. 初始化](#133-初始化)
        - [1.3.4. 可使用函数](#134-可使用函数)
        - [1.3.5. 使用方法](#135-使用方法)
    - [1.4. 可持久化线段树](#14-可持久化线段树)
        - [1.4.1. 全局变量](#141-全局变量)
        - [1.4.2. 离散化](#142-离散化)
        - [1.4.3. 线段树相关](#143-线段树相关)
        - [1.4.4. 实例](#144-实例)
        - [1.4.5. 用法](#145-用法)
- [2. 算法](#2-算法)
    - [2.1. 矩阵快速幂](#21-矩阵快速幂)
    ...
    - [2.2. 生成树计数](#22-生成树计数)
        ...
        - [2.2.2. 代码](#222-代码)
    - [2.3. 次小生成树](#23-次小生成树)
        - [2.3.1. 全局变量&结构体](#231-全局变量结构体)
        - [2.3.2. 算法](#232-算法)
    - [2.4. 最小树形图](#24-最小树形图)
        - [2.4.1. 宏&常量&结构体&变量](#241-宏常量结构体变量)
        - [2.4.2. 算法](#242-算法)
- [3. 数论](#3-数论)
    - [3.1. 扩展欧几里得](#31-扩展欧几里得)
        ...
        - [3.1.2. 代码](#312-代码)
        - [3.1.3. 求逆元](#313-求逆元)
    - [3.2. 中国剩余定理](#32-中国剩余定理)
        - [3.2.1. 定义&通式](#321-定义通式)
        - [3.2.2. 代码](#322-代码)
    - [3.3. 欧拉函数](#33-欧拉函数)
        - [3.3.1. 定义&通式](#331-定义通式)
        - [3.3.2. 代码](#332-代码)
    - [3.4. 素数筛法](#34-素数筛法)
        - [3.4.1. 线形筛](#341-线形筛)
        - [3.4.2. 复杂度 $O(n^{\frac{3}{4}})$](#342-复杂度-onfrac34)
        - [3.4.3. 复杂度 $O(n^{\frac{2}{3}})$](#343-复杂度-onfrac23)
    - [3.5. miller-rabin素性判断](#35-miller-rabin素性判断)
        - [3.5.1. 代码](#351-代码)
    - [3.6. 莫比乌斯函数](#36-莫比乌斯函数)
        - [3.6.1. 定义](#361-定义)
        - [3.6.2. 莫比乌斯反演](#362-莫比乌斯反演)
        - [3.6.3. 技巧](#363-技巧)
- [4. STL](#4-stl)
    - [4.1. 求合并,交集,并集，差集](#41-求合并交集并集，差集)
    - [4.2. 二分查找](#42-二分查找)
    - [4.3. 字符串操作](#43-字符串操作)
    - [4.4. 读入优化](#44-读入优化)
- [5. Java](#5-java)
    - [5.1. a+b problem](#51-ab-problem)
    - [5.2. BigInteger](#52-biginteger)
        - [5.2.1. 构造函数](#521-构造函数)
        - [5.2.2. 方法](#522-方法)
    - [5.3. BigDecimal](#53-bigdecimal)
        - [5.3.1. 舍入方式](#531-舍入方式)
        - [5.3.2. 方法](#532-方法)
